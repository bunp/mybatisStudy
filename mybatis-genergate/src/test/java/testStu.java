...
//            stuExample.createCriteria().andStuIdEqualTo(3);
//            stuExample.or().andClassIdEqualTo(3);
           PageHelper.startPage(1, 3);
            List<Stu> stus =  mapper.selectByExample(null);
            PageInfo<Stu> stuPageInfo = new PageInfo<>(stus, 5);
